...
DEPLOY_DIR="${DRIVER_DIR}/deploy/kubernetes-1.34"
...
echo "Ensuring CSI Hostpath Driver is checked out to pinned commit (v1.18.0)..."
cd "${DRIVER_DIR}"
git fetch origin cc78ee78ae23908c9e0607df2fe09c7ecfa52597
git checkout cc78ee78ae23908c9e0607df2fe09c7ecfa52597
cd -
...
# 9. Create the CSIDriverConfig for Substrate
...
# 10. Restart atelet to recreate image cache directories if they were wiped
