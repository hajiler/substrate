...
// MustCreateExternalVolume ensures volume's parent atespace exists, then
// stores volume as given — ready or still pending, whichever state the test
// needs to start from. Use the store method directly only in tests that
// exercise missing-parent behavior.
