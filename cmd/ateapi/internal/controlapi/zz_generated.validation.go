...
func Validate_Actor(
	...
	{ // field ateapipb.Actor.ExternalVolumeBindings
		fn := func(
			fldPath *field.Path,
			...
			if e := validate.EachMapKey(ctx, op, fldPath, obj, oldObj, validate.ShortName); len(e) != 0 {
				errs = append(errs, e...)
			}
			if e := validate.EachMapVal(ctx, op, fldPath, obj, oldObj, validate.DirectEqual, validate.ShortName); len(e) != 0 {
				errs = append(errs, e...)
			}
			return
		}
		oldVal := safe.Field(oldObj,
			func(oldObj *ateapipb.Actor) map[string]string {
				return oldObj.ExternalVolumeBindings
			})
		errs = append(errs, fn(fldPath.Child("external_volume_bindings"), obj.ExternalVolumeBindings, oldVal, oldObj != nil)...)
	}
...
func Validate_ActorRef(
	ctx context.Context, op operation.Operation, fldPath *field.Path,
	obj, oldObj *ateapipb.ActorRef) (errs field.ErrorList) {

	{ // field ateapipb.ActorRef.ActorUid
		fn := func(
			fldPath *field.Path,
			obj, oldObj *string,
			oldValueCorrelated bool) (errs field.ErrorList) {
	...
	{ // field ateapipb.ActorRef.Active
		fn := func(
			fldPath *field.Path,
			obj, oldObj *bool,
			oldValueCorrelated bool) (errs field.ErrorList) {
		...
		oldVal := safe.Field(oldObj,
			func(oldObj *ateapipb.ActorRef) *bool {
				return &oldObj.Active
			})
		errs = append(errs, fn(fldPath.Child("active"), &obj.Active, oldVal, oldObj != nil)...)
	}
...
func Validate_ActorStatus(
	...
	{ // field ateapipb.ActorStatus.ActorVolumes
		fn := func(
			fldPath *field.Path,
			obj, oldObj []*ateapipb.ActorVolumeStatus,
			oldValueCorrelated bool) (errs field.ErrorList) {
			// don't revalidate unchanged data
			if oldValueCorrelated && op.Type == operation.Update {
				if ateDeepEqual(obj, oldObj) {
			...
			// call field-attached validations
			earlyReturn := false
			if e := validate.PtrSliceNoNils[ateapipb.ActorVolumeStatus](ctx, op, fldPath, obj, oldObj).MarkShortCircuit(); len(e) != 0 {
				errs = append(errs, e...)
				earlyReturn = true
			}
			...
			// lists with map semantics require unique keys
			if e := validate.PtrSliceUnique(ctx, op, fldPath, obj, oldObj,
				func(a *ateapipb.ActorVolumeStatus, b *ateapipb.ActorVolumeStatus) bool {
			...
			if e := validate.EachPtrSliceVal(ctx, op, fldPath, obj, oldObj,
				func(a *ateapipb.ActorVolumeStatus, b *ateapipb.ActorVolumeStatus) bool {
					return a.VolumeName == b.VolumeName
				}, ateDeepEqual, Validate_ActorVolumeStatus); len(e) != 0 {
				errs = append(errs, e...)
			}
			return
		}
		oldVal := safe.Field(oldObj,
			func(oldObj *ateapipb.ActorStatus) []*ateapipb.ActorVolumeStatus {
...
// Validate_ActorVolumeStatus validates an instance of ActorVolumeStatus according
// to declarative validation rules in the API schema.
func Validate_ActorVolumeStatus(
	ctx context.Context, op operation.Operation, fldPath *field.Path,
	obj, oldObj *ateapipb.ActorVolumeStatus) (errs field.ErrorList) {

	{ // field ateapipb.ActorVolumeStatus.VolumeName
		fn := func(
			fldPath *field.Path,
			obj, oldObj *string,
			oldValueCorrelated bool) (errs field.ErrorList) {
	...
	{ // field ateapipb.ActorVolumeStatus.StorageVolumeId
		fn := func(
			...
			// custom validation
			if e := ValidateCustom_ActorVolumeStatus_StorageVolumeId(ctx, op, fldPath, obj, oldObj); len(e) != 0 {
				errs = append(errs, e...)
			}
	...
	{ // field ateapipb.ActorVolumeStatus.VolumeType
		fn := func(
			fldPath *field.Path,
			obj, oldObj *string,
			oldValueCorrelated bool) (errs field.ErrorList) {
			...
			// custom validation
			if e := ValidateCustom_ActorVolumeStatus_VolumeType(ctx, op, fldPath, obj, oldObj); len(e) != 0 {
				errs = append(errs, e...)
			}
			if e := validate.MaxLength(ctx, op, fldPath, obj, oldObj, 253); len(e) != 0 {
				errs = append(errs, e...)
	...
	{ // field ateapipb.ActorVolumeStatus.Status
		fn := func(
			fldPath *field.Path,
			obj, oldObj *ateapipb.ActorVolumeStatus_Status,
			oldValueCorrelated bool) (errs field.ErrorList) {
			// don't revalidate unchanged data
			if oldValueCorrelated && op.Type == operation.Update {
				if obj == oldObj || (obj != nil && oldObj != nil && *obj == *oldObj) {
		...
		oldVal := safe.Field(oldObj,
			func(oldObj *ateapipb.ActorVolumeStatus) *ateapipb.ActorVolumeStatus_Status {
				return &oldObj.Status
			})
		errs = append(errs, fn(fldPath.Child("status"), &obj.Status, oldVal, oldObj != nil)...)
	}

	{ // field ateapipb.ActorVolumeStatus.VolumeContext
		fn := func(
			fldPath *field.Path,
			obj, oldObj map[string]string,
			oldValueCorrelated bool) (errs field.ErrorList) {
	...
	{ // field ateapipb.ActorVolumeStatus.ExternalVolumeName
		...
		oldVal := safe.Field(oldObj,
			func(oldObj *ateapipb.ActorVolumeStatus) *string {
				return &oldObj.ExternalVolumeName
			})
		errs = append(errs, fn(fldPath.Child("external_volume_name"), &obj.ExternalVolumeName, oldVal, oldObj != nil)...)
	}
...
// Validate_CreateExternalVolumeRequest validates an instance of CreateExternalVolumeRequest according
// to declarative validation rules in the API schema.
func Validate_CreateExternalVolumeRequest(
	ctx context.Context, op operation.Operation, fldPath *field.Path,
	obj, oldObj *ateapipb.CreateExternalVolumeRequest) (errs field.ErrorList) {

	// custom validation
	if e := ValidateCustom_CreateExternalVolumeRequest(ctx, op, fldPath, obj, oldObj); len(e) != 0 {
		errs = append(errs, e...)
	}

	{ // field ateapipb.CreateExternalVolumeRequest.ExternalVolume
		fn := func(
			fldPath *field.Path,
		...
		oldVal := safe.Field(oldObj,
			func(oldObj *ateapipb.CreateExternalVolumeRequest) *ateapipb.ExternalVolume {
...
// Validate_DeleteExternalVolumeRequest validates an instance of DeleteExternalVolumeRequest according
// to declarative validation rules in the API schema.
func Validate_DeleteExternalVolumeRequest(
	ctx context.Context, op operation.Operation, fldPath *field.Path,
	obj, oldObj *ateapipb.DeleteExternalVolumeRequest) (errs field.ErrorList) {

	{ // field ateapipb.DeleteExternalVolumeRequest.ExternalVolume
		fn := func(
			fldPath *field.Path,
			obj, oldObj *ateapipb.ObjectRef,
			oldValueCorrelated bool) (errs field.ErrorList) {
		...
		oldVal := safe.Field(oldObj,
			func(oldObj *ateapipb.DeleteExternalVolumeRequest) *ateapipb.ObjectRef {
				return oldObj.ExternalVolume
			})
		errs = append(errs, fn(fldPath.Child("external_volume"), obj.ExternalVolume, oldVal, oldObj != nil)...)
	}

	{ // field ateapipb.DeleteExternalVolumeRequest.Options
		fn := func(
			fldPath *field.Path,
			obj, oldObj *ateapipb.DeleteOptions,
			oldValueCorrelated bool) (errs field.ErrorList) {
		...
		oldVal := safe.Field(oldObj,
			func(oldObj *ateapipb.DeleteExternalVolumeRequest) *ateapipb.DeleteOptions {
				return oldObj.Options
			})
		errs = append(errs, fn(fldPath.Child("options"), obj.Options, oldVal, oldObj != nil)...)
	}
...
func Validate_ExternalVolume(
	...
	{ // field ateapipb.ExternalVolume.Metadata
		fn := func(
			fldPath *field.Path,
			obj, oldObj *ateapipb.ResourceMetadata,
			oldValueCorrelated bool) (errs field.ErrorList) {
		...
		oldVal := safe.Field(oldObj,
			func(oldObj *ateapipb.ExternalVolume) *ateapipb.ResourceMetadata {
				return oldObj.Metadata
			})
		errs = append(errs, fn(fldPath.Child("metadata"), obj.Metadata, oldVal, oldObj != nil)...)
	}

	{ // field ateapipb.ExternalVolume.DeleteTrigger
		fn := func(
			fldPath *field.Path,
			obj, oldObj *ateapipb.DeleteTrigger,
			oldValueCorrelated bool) (errs field.ErrorList) {
			// don't revalidate unchanged data
			if oldValueCorrelated && op.Type == operation.Update {
				if obj == oldObj || (obj != nil && oldObj != nil && *obj == *oldObj) {
		...
		oldVal := safe.Field(oldObj,
			func(oldObj *ateapipb.ExternalVolume) *ateapipb.DeleteTrigger {
				return &oldObj.DeleteTrigger
			})
		errs = append(errs, fn(fldPath.Child("delete_trigger"), &obj.DeleteTrigger, oldVal, oldObj != nil)...)
	}

	{ // field ateapipb.ExternalVolume.StorageClassName
		fn := func(
			fldPath *field.Path,
			obj, oldObj *string,
			oldValueCorrelated bool) (errs field.ErrorList) {
	...
	{ // field ateapipb.ExternalVolume.VolumeId
		fn := func(
			fldPath *field.Path,
			obj, oldObj *string,
			oldValueCorrelated bool) (errs field.ErrorList) {
			...
			// custom validation
			if e := ValidateCustom_ExternalVolume_VolumeId(ctx, op, fldPath, obj, oldObj); len(e) != 0 {
				errs = append(errs, e...)
			}
			if e := validate.MaxLength(ctx, op, fldPath, obj, oldObj, 256); len(e) != 0 {
				errs = append(errs, e...)
		...
		oldVal := safe.Field(oldObj,
			func(oldObj *ateapipb.ExternalVolume) *string {
				return &oldObj.VolumeId
			})
		errs = append(errs, fn(fldPath.Child("volume_id"), &obj.VolumeId, oldVal, oldObj != nil)...)
	}
	...
	{ // field ateapipb.ExternalVolume.Status
		fn := func(
			fldPath *field.Path,
			obj, oldObj *ateapipb.ExternalVolumeStatus,
			oldValueCorrelated bool) (errs field.ErrorList) {
			// don't revalidate unchanged data
			if oldValueCorrelated && op.Type == operation.Update {
				if ateDeepEqual(obj, oldObj) {
			...
			// call the type's validation function
			errs = append(errs, Validate_ExternalVolumeStatus(ctx, op, fldPath, obj, oldObj)...)
			return
		}
		oldVal := safe.Field(oldObj,
			func(oldObj *ateapipb.ExternalVolume) *ateapipb.ExternalVolumeStatus {
				return oldObj.Status
			})
		errs = append(errs, fn(fldPath.Child("status"), obj.Status, oldVal, oldObj != nil)...)
	}

	{ // field ateapipb.ExternalVolume.Capacity
		fn := func(
			fldPath *field.Path,
			obj, oldObj *string,
			oldValueCorrelated bool) (errs field.ErrorList) {
			...
			// custom validation
			if e := ValidateCustom_ExternalVolume_Capacity(ctx, op, fldPath, obj, oldObj); len(e) != 0 {
				errs = append(errs, e...)
			}
	...
	{ // field ateapipb.ExternalVolume.AccessMode
		fn := func(
			fldPath *field.Path,
			obj, oldObj *ateapipb.AccessMode,
			oldValueCorrelated bool) (errs field.ErrorList) {
			// don't revalidate unchanged data
			if oldValueCorrelated && op.Type == operation.Update {
				if obj == oldObj || (obj != nil && oldObj != nil && *obj == *oldObj) {
			...
			if e := validate.UpdateValue(ctx, op, fldPath, obj, oldObj,
				func(a ateapipb.AccessMode, b ateapipb.AccessMode) bool { return a == b }, validate.NoUnset, validate.NoModify).MarkShortCircuit(); len(e) != 0 {
				errs = append(errs, e...)
				earlyReturn = true
			}
			if earlyReturn {
		...
		oldVal := safe.Field(oldObj,
			func(oldObj *ateapipb.ExternalVolume) *ateapipb.AccessMode {
...
// Validate_ExternalVolumeRef validates an instance of ExternalVolumeRef according
// to declarative validation rules in the API schema.
func Validate_ExternalVolumeRef(
	ctx context.Context, op operation.Operation, fldPath *field.Path,
	obj, oldObj *ateapipb.ExternalVolumeRef) (errs field.ErrorList) {

	{ // field ateapipb.ExternalVolumeRef.Name
		fn := func(
			fldPath *field.Path,
			obj, oldObj *string,
			oldValueCorrelated bool) (errs field.ErrorList) {
		...
		oldVal := safe.Field(oldObj,
			func(oldObj *ateapipb.ExternalVolumeRef) *string {
				return &oldObj.Name
			})
		errs = append(errs, fn(fldPath.Child("name"), &obj.Name, oldVal, oldObj != nil)...)
	}
...
// Validate_ExternalVolumeStatus validates an instance of ExternalVolumeStatus according
// to declarative validation rules in the API schema.
func Validate_ExternalVolumeStatus(
	ctx context.Context, op operation.Operation, fldPath *field.Path,
	obj, oldObj *ateapipb.ExternalVolumeStatus) (errs field.ErrorList) {

	{ // field ateapipb.ExternalVolumeStatus.State
		fn := func(
			fldPath *field.Path,
			obj, oldObj *ateapipb.ExternalVolumeState,
			oldValueCorrelated bool) (errs field.ErrorList) {
			// don't revalidate unchanged data
			if oldValueCorrelated && op.Type == operation.Update {
				if obj == oldObj || (obj != nil && oldObj != nil && *obj == *oldObj) {
		...
		oldVal := safe.Field(oldObj,
			func(oldObj *ateapipb.ExternalVolumeStatus) *ateapipb.ExternalVolumeState {
				return &oldObj.State
			})
		errs = append(errs, fn(fldPath.Child("state"), &obj.State, oldVal, oldObj != nil)...)
	}

	{ // field ateapipb.ExternalVolumeStatus.Refs
		fn := func(
			fldPath *field.Path,
			obj, oldObj []*ateapipb.ActorRef,
			oldValueCorrelated bool) (errs field.ErrorList) {
			// don't revalidate unchanged data
			if oldValueCorrelated && op.Type == operation.Update {
				if ateDeepEqual(obj, oldObj) {
			...
			// call field-attached validations
			earlyReturn := false
			if e := validate.PtrSliceNoNils[ateapipb.ActorRef](ctx, op, fldPath, obj, oldObj).MarkShortCircuit(); len(e) != 0 {
				errs = append(errs, e...)
				earlyReturn = true
			}
			if e := validate.MaxItems(ctx, op, fldPath, obj, oldObj, 256).MarkShortCircuit(); len(e) != 0 {
			...
			// lists with map semantics require unique keys
			if e := validate.PtrSliceUnique(ctx, op, fldPath, obj, oldObj,
				func(a *ateapipb.ActorRef, b *ateapipb.ActorRef) bool { return a.ActorUid == b.ActorUid }); len(e) != 0 {
				errs = append(errs, e...)
			}
			// iterate the list and call the type's validation function
			if e := validate.EachPtrSliceVal(ctx, op, fldPath, obj, oldObj,
				func(a *ateapipb.ActorRef, b *ateapipb.ActorRef) bool { return a.ActorUid == b.ActorUid }, ateDeepEqual, Validate_ActorRef); len(e) != 0 {
				errs = append(errs, e...)
			}
			return
		}
		oldVal := safe.Field(oldObj,
			func(oldObj *ateapipb.ExternalVolumeStatus) []*ateapipb.ActorRef {
				return oldObj.Refs
			})
		errs = append(errs, fn(fldPath.Child("refs"), obj.Refs, oldVal, oldObj != nil)...)
	}
...
// Validate_GetExternalVolumeRequest validates an instance of GetExternalVolumeRequest according
// to declarative validation rules in the API schema.
func Validate_GetExternalVolumeRequest(
	ctx context.Context, op operation.Operation, fldPath *field.Path,
	obj, oldObj *ateapipb.GetExternalVolumeRequest) (errs field.ErrorList) {

	{ // field ateapipb.GetExternalVolumeRequest.ExternalVolume
		fn := func(
			fldPath *field.Path,
			obj, oldObj *ateapipb.ObjectRef,
			oldValueCorrelated bool) (errs field.ErrorList) {
		...
		oldVal := safe.Field(oldObj,
			func(oldObj *ateapipb.GetExternalVolumeRequest) *ateapipb.ObjectRef {
				return oldObj.ExternalVolume
			})
		errs = append(errs, fn(fldPath.Child("external_volume"), obj.ExternalVolume, oldVal, oldObj != nil)...)
	}
...
// Validate_ListExternalVolumesRequest validates an instance of ListExternalVolumesRequest according
// to declarative validation rules in the API schema.
func Validate_ListExternalVolumesRequest(
	ctx context.Context, op operation.Operation, fldPath *field.Path,
	obj, oldObj *ateapipb.ListExternalVolumesRequest) (errs field.ErrorList) {

	{ // field ateapipb.ListExternalVolumesRequest.Atespace
		fn := func(
			fldPath *field.Path,
			obj, oldObj *string,
			oldValueCorrelated bool) (errs field.ErrorList) {
		...
		oldVal := safe.Field(oldObj,
			func(oldObj *ateapipb.ListExternalVolumesRequest) *string {
				return &oldObj.Atespace
			})
		errs = append(errs, fn(fldPath.Child("atespace"), &obj.Atespace, oldVal, oldObj != nil)...)
	}

	{ // field ateapipb.ListExternalVolumesRequest.PageSize
		fn := func(
			fldPath *field.Path,
			obj, oldObj *int32,
			oldValueCorrelated bool) (errs field.ErrorList) {
		...
		oldVal := safe.Field(oldObj,
			func(oldObj *ateapipb.ListExternalVolumesRequest) *int32 {
				return &oldObj.PageSize
			})
		errs = append(errs, fn(fldPath.Child("page_size"), &obj.PageSize, oldVal, oldObj != nil)...)
	}

	{ // field ateapipb.ListExternalVolumesRequest.PageToken
		fn := func(
			fldPath *field.Path,
			obj, oldObj *string,
			oldValueCorrelated bool) (errs field.ErrorList) {
...
// Validate_UpdateExternalVolumeRequest validates an instance of UpdateExternalVolumeRequest according
// to declarative validation rules in the API schema.
func Validate_UpdateExternalVolumeRequest(
	ctx context.Context, op operation.Operation, fldPath *field.Path,
	obj, oldObj *ateapipb.UpdateExternalVolumeRequest) (errs field.ErrorList) {

	{ // field ateapipb.UpdateExternalVolumeRequest.ExternalVolume
		fn := func(
			fldPath *field.Path,
			obj, oldObj *ateapipb.ExternalVolume,
			oldValueCorrelated bool) (errs field.ErrorList) {
			...
			// custom validation
			if e := ValidateCustom_UpdateExternalVolumeRequest_ExternalVolume(ctx, op, fldPath, obj, oldObj); len(e) != 0 {
				errs = append(errs, e...)
			}
			func() { // cohort = "metadata"
				earlyReturn := false
				if e := validate.Subfield(ctx, op, fldPath, obj, oldObj, "metadata",
					func(o *ateapipb.ExternalVolume) *ateapipb.ResourceMetadata { return o.Metadata }, ateDeepEqual, validate.RequiredPointer).MarkShortCircuit(); len(e) != 0 {
					errs = append(errs, e...)
					earlyReturn = true
				}
				if earlyReturn {
		...
		oldVal := safe.Field(oldObj,
			func(oldObj *ateapipb.UpdateExternalVolumeRequest) *ateapipb.ExternalVolume {
				return oldObj.ExternalVolume
			})
		errs = append(errs, fn(fldPath.Child("external_volume"), obj.ExternalVolume, oldVal, oldObj != nil)...)
	}
...
var unionMembershipFor_github_com_agent_substrate_substrate_pkg_proto_ateapipb_Volume_ = validate.NewUnionMembership(validate.NewUnionMember("durable_dir"), validate.NewUnionMember("external_volume_template"), validate.NewUnionMember("external_volume_ref"), validate.NewUnionMember("system_info"), validate.NewUnionMember("image"))
...
func Validate_Volume(
	...
	if e := validate.Union(ctx, op, fldPath, obj, oldObj, unionMembershipFor_github_com_agent_substrate_substrate_pkg_proto_ateapipb_Volume_,
		...
		func(obj *ateapipb.Volume) bool {
			...
			return obj.ExternalVolumeRef != nil
		},
		func(obj *ateapipb.Volume) bool {
			if obj == nil {
				return false
	...
	{ // field ateapipb.Volume.ExternalVolumeRef
		fn := func(
			fldPath *field.Path,
			obj, oldObj *ateapipb.ExternalVolumeRef,
			oldValueCorrelated bool) (errs field.ErrorList) {
			// don't revalidate unchanged data
			if oldValueCorrelated && op.Type == operation.Update {
				if ateDeepEqual(obj, oldObj) {
			...
			// call the type's validation function
			errs = append(errs, Validate_ExternalVolumeRef(ctx, op, fldPath, obj, oldObj)...)
			return
		}
		oldVal := safe.Field(oldObj,
			func(oldObj *ateapipb.Volume) *ateapipb.ExternalVolumeRef {
				return oldObj.ExternalVolumeRef
			})
		errs = append(errs, fn(fldPath.Child("external_volume_ref"), obj.ExternalVolumeRef, oldVal, oldObj != nil)...)
	}
