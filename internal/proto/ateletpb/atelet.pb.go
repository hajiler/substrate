...
// EmptyDirVolume is an empty host directory at the external volume path.
...
func (x *Volume) GetEmptyDir() *EmptyDirVolume {
	if x != nil {
		if x, ok := x.Source.(*Volume_EmptyDir); ok {
			return x.EmptyDir
		}
	}
	return nil
...
type Volume_EmptyDir struct {
	EmptyDir *EmptyDirVolume `protobuf:"bytes,6,opt,name=empty_dir,json=emptyDir,proto3,oneof"`
}
...
const file_atelet_proto_rawDesc = "" +
	...
	"\x10DurableDirVolume\"\x10\n" +
	"\x0eEmptyDirVolume\"\xfd\x01\n" +
	...
	"\fdata_sources\x18\x01 \x03(\v2\x1c.atelet.SystemInfoDataSourceR\vdataSources\"\xc6\x02\n" +
	"\x06Volume\x12\x12\n" +
	...
	"systemInfo\x121\n" +
	"\x05image\x18\x05 \x01(\v2\x19.atelet.ImageVolumeSourceH\x00R\x05image\x125\n" +
	"\tempty_dir\x18\x06 \x01(\v2\x16.atelet.EmptyDirVolumeH\x00R\bemptyDirB\b\n" +
	"\x06source\"@\n" +
...
var file_atelet_proto_goTypes = []any{
	...
	(*EmptyDirVolume)(nil),                  // 16: atelet.EmptyDirVolume
	...
	(*WakeupProbe)(nil),                     // 31: atelet.WakeupProbe
...
var file_atelet_proto_depIdxs = []int32{
	...
	16, // 19: atelet.Volume.empty_dir:type_name -> atelet.EmptyDirVolume
	30, // 20: atelet.Container.env:type_name -> atelet.EnvEntry
	31, // 21: atelet.Container.wakeup_probe:type_name -> atelet.WakeupProbe
	25, // 22: atelet.Container.volume_mounts:type_name -> atelet.VolumeMount
	27, // 23: atelet.Container.security_context:type_name -> atelet.SecurityContext
	29, // 24: atelet.Container.resources:type_name -> atelet.ResourceLimits
	28, // 25: atelet.SecurityContext.capabilities:type_name -> atelet.Capabilities
	32, // 26: atelet.WakeupProbe.http_get:type_name -> atelet.HTTPGetAction
